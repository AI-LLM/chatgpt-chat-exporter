...
当DOM结构为samples/chatgpt-example-2choices.html时，有“回复 1”，“回复 2”两条回复，第二条输出成：
```markdown
### **You**

这是一个**非常好的问题**，而且正是当前软件工程与 AI 研究的核心方向之一。简要回答是：**有，而且已经形成了比较系统的“编程任务分类 + 自动化可行性评估”研究框架**。下面我从**学术研究、工业实践、以及 AI 能力边界**三个层面，系统性地给你梳理一下。
```
应该输出“### **ChatGPT**”。同时要增加“回复 1”，“回复 2”的区分
